...
disp('		Simulation 4. Distance2centreVSArea in a bundary free grill');
disp('________________________________________________________________________')
simulation_parameters 		= [];
simulation_parameters.B		= buildInteractionBoundaryFreeMatrix(1.25, 1, 50, 2);
...
for iter_y  = 1 : 1 : 5
	for iter_x = 1 : 1 : 5
		...
		save(['sim_4_', num2str(saving_number)], 'report_library');
	end
end
