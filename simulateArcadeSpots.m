				...
				for day = 1 : 1 : harvest
					...
					for individual = 1 : 1 : nsize  ^ 2
						...
						if all([state(1).A(individual), state(2).A(individual), state(3).A(individual)] == 1) == 1
							...
							state(1).omega(individual) = state(1).omega(individual) + systemic_infection_matrix(individual,1)*w(1);
							state(2).omega(individual) = state(2).omega(individual) + systemic_infection_matrix(individual,2)*w(2);
							state(3).omega(individual) = state(3).omega(individual) + systemic_infection_matrix(individual,3)*w(3);
